...
#define __debug(...)    //nontask_debug(__VA_ARGS__)
#define __db(...)       //nontask_debug(__VA_ARGS__)

#ifndef SW_I2C_Delay
#define SW_I2C_Delay()     __delay_us(8) //f=1/2*(8*1e-6)=62.5kHz
#endif
...
#ifndef SW_I2C_VBUS_SetDigitalMode
#define SW_I2C_VBUS_SetDigitalMode()
#endif
...
void SW_I2C_Init(void) // <editor-fold defaultstate="collapsed" desc="Soft I2C initialize">
{
...
static void SW_I2C_Drv_Open(void) // <editor-fold defaultstate="collapsed" desc="I2C driver open">
{
    SW_I2C_VBUS_SetHigh();
    SW_I2C_VBUS_SetDigitalMode();
    SW_SCL_SetHigh();
    SW_SDA_SetHigh();
...
static void SW_I2C_Drv_Close(void) // <editor-fold defaultstate="collapsed" desc="I2C driver close">
{
    SW_I2C_Delay();
    SW_SCL_SetHigh();
    SW_SDA_SetHigh();
...
static void SW_I2C_SCL_Pulse(bool x) // <editor-fold defaultstate="collapsed" desc="SCL pulse">
{
    if(x)
    {
        SW_SCL_SetDigitalInput();
...
static void SW_I2C_SDA_Pulse(bool x) // <editor-fold defaultstate="collapsed" desc="SDA pulse">
{
    if(x)
    {
        SW_SDA_SetDigitalInput();
...
static void SW_I2C_WriteBit(bool x) // <editor-fold defaultstate="collapsed" desc="Write 1 bit">
{
...
static bool SW_I2C_ReadBit(void) // <editor-fold defaultstate="collapsed" desc="Write 1 bit">
{
    //bool x;
    // preparing for SDA changing
    SW_I2C_SCL_Pulse(0);
...
static void SW_I2C_Start(void) // <editor-fold defaultstate="collapsed" desc="Start bit">
{
    /* SDA ---
             |______
       SCL ------
...
static void SW_I2C_Stop(void) // <editor-fold defaultstate="collapsed" desc="Stop bit">
{
    /* SDA    ------
           ___|
           ---------                                            
...
static uint8_t SW_I2C_ReadByte(void) // <editor-fold defaultstate="collapsed" desc="Read byte">
{
    uint8_t i;
...
static void SW_I2C_SendAck(bool ack) // <editor-fold defaultstate="collapsed" desc="Send ACK">
{
    if(ack)
        SW_I2C_WriteBit(0);
    else
...
static uint8_t SW_I2C_Read(bool ack) // <editor-fold defaultstate="collapsed" desc="Read byte+ send ACK">
{
...
static bool SW_I2C_Write(uint8_t data_out) // <editor-fold defaultstate="collapsed" desc="Write byte">
{
    uint8_t i;
...
static void SW_I2C_Tasks(void) // <editor-fold defaultstate="collapsed" desc="I2C task">
{
...
void SW_I2C_ReadNBytes(uint8_t address, uint8_t *data, size_t len) // <editor-fold defaultstate="collapsed" desc="Read n bytes">
{
    uint8_t i;
...
void SW_I2C_WriteNBytes(uint8_t address, uint8_t *data, size_t len) // <editor-fold defaultstate="collapsed" desc="Write n bytes">
{
    uint8_t i;
...
int8_t SW_I2C_Open(uint8_t SlvAddr) // <editor-fold defaultstate="collapsed" desc="I2C open">
{
...
int8_t SW_I2C_Close(void) // <editor-fold defaultstate="collapsed" desc="I2C close">
{
    SW_I2C_Drv_Close();
    Sw_I2c_Cxt.DoNext=SW_I2C_START;
    return SW_I2C_OK;
...
int8_t SW_I2C_MasterOperation(bool read) // <editor-fold defaultstate="collapsed" desc="I2C read/write">
{
...
void SW_I2C_SetBuffer(void *buffer, size_t bufferSize) // <editor-fold defaultstate="collapsed" desc="Set buffer">
{
